var createCanvas = function(canvasElem) {
    ...
    canvas.draw = function(shape, size, x, y, color) {
        ...
        context.closePath();
        context.fill();
        console.log("I bim vertik gedrownt");
    };
    ...
    canvas.getLocationCoords = function(location, size) {
      var coords = [];
      var margin = size / 2;
      var x,y;

      if (location == "top") {
        x = canvasElem.width / 2; //x top
        y = canvasElem.height * 5 / 6;
        //y = (canvasElem.height / (size + margin)) * 5 / 6; //y top
        console.log("Debug: "+x+", "+y);
      } else if (location == "bottom" || location == "bot") {
        x = canvasElem.width / 2; //x bot
        y = canvasElem.height / 6;
        //y = (canvasElem.height / (size + margin)) / 6; //y bot
        console.log("Debug: "+x+", "+y);
      } else if (location == "left") {
        x = canvasElem.width / 6;
        //x = (canvasElem.width / (size + (margin / 2))) / 6; //x left
        y = canvasElem.height / 2; //y left
        console.log("Debug: "+x+", "+y);
      } else if (location == "right") {
        x = canvasElem.width * 5 / 6;
        //x = (canvasElem.width / (size + (margin / 2))) * 5 / 6; //x right
        y = canvasElem.height / 2; //y right
        console.log("Debug: "+x+", "+y);
      } else {
        //center as default
