...
exp.init = function(){
  ...
  config_deploy.submissionURL = config_deploy.deployMethod == "localServer"? "http://localhost:4000/api/submit_experiment": "https://probability-matching.herokuapp.com/api/submit_experiment/1"
