...
exp.init = function(){
  ...
  config_deploy.submissionURL = config_deploy.deployMethod == "localServer"? "http://localhost:4000/api/submit_experiment": "https://mcmpact.ikw.uni-osnabrueck.de:4000/api/submit_experiment/" + config_deploy.experimentID;
